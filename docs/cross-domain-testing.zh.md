...
> **Language / 语言**：[English](cross-domain-testing.md) · **中文（当前）**
...
请使用以下模板提交跨学科测试报告（在 [Discussions / Show and tell](https://github.com/tizzy916/humanities-writing-companion/discussions/categories/show-and-tell) 中开新主题）：
