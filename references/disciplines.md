# Humanities Discipline-Specific Dimensions · Full Tables

> Loaded on demand from SKILL.md. The routing protocol lives in SKILL.md; this file is its payload. 中文版：disciplines.zh.md
...
**Inheritance**: History + Science + Philosophy. (Also serves science & technology studies (STS) — same inheritance, plus the Media studies overlay where the material is contemporary technoscience.)
